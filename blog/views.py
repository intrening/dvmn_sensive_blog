...
def serialize_post_optimized(post):
    return {
        ...
        "slug": post.slug,
        "tags": [serialize_tag_uptimized(tag) for tag in post.tags.annotate(Count('posts'))],
...
def serialize_tag_uptimized(tag):
    return {
        'title': tag.title,
...
def index(request):
    ...
    context = {
        ...
        'popular_tags': [serialize_tag_uptimized(tag) for tag in most_popular_tags],
    }
